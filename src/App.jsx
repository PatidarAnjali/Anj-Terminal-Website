...
const navigateTo = (page) => {
  ...
  return (
    <div className={`${colors.bgColor} ${colors.textColor} transition-colors duration-300 min-h-screen relative`}>
      ...
      {currentPage !== "maximized" && (
        <footer className={`absolute bottom-0 left-0 right-0 pt-6 pb-4 text-center ${colors.secondaryText} text-sm`}>
          © 2026 Anjali Patidar
        </footer>
      )}
    </div>
